...
//wss://one0xdevspd-chatapp.onrender.com
  ...
  const handleEmojiClick=(emojiData:any)=>{
    if (inputRef.current) {
      ...
      const newValue = currentValue.slice(0, cursorPosition) + emojiData.emoji + currentValue.slice(cursorPosition);
      ...
      <div className='flex-1 flex flex-col'>
        ...
        <div className='max-w-3xl mx-auto p-3 sm:p-4 flex items-center gap-2'>
          ...
          <button 
            ...
            className='emoji-button p-2 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors'
            title='Add emoji'
          >
